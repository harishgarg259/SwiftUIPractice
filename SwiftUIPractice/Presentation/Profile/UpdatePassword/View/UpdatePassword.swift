...
struct ChangePasswordView: View {
    ...
    @StateObject var userModel: UpdatePasswordViewModel = UpdatePasswordViewModel()
    ...
    var body: some View {
        VStack(spacing: 20) {
            ...
            Button(action: {
                ...
                self.userModel.updatePassword(oldPassword: self.oldPassword, newPassword: self.newPassword)
            }, label: {
...
struct ChangePasswordView_Previews: PreviewProvider {
    static var previews: some View {
        ChangePasswordView(userModel: UpdatePasswordViewModel())
    }
}
